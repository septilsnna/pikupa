    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-light bg-light" style="color:#424242;">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"
                        ...
                        <a class="dropdown-item disabled" href="/Home/order/custom_design">Custom Design</a>
                    </div>
                </li>
            </ul>
        </div>
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <div class="navbar-nav">
                <a class="nav-link btn px-2" role="button" href="/Home/login">Login</a>
                <a class="nav-link btn px-2" role="button" href="/Home/register">Sign Up</a>
            </div>
        </div>
    </nav>
</head>
...
<body style="background-color:#f7f7f7; font-family: Montserrat; font-style: normal; color: #424242;">
    <div class="container my-5 py-2 text-center">
        ...
        <div class="row">
            <div class="col pt-3 px-lg-5">
                <a href="/Home/portfolio/twitter_profile_needs/11"><small class="text-secondary"
        ...
        <div class="row py-5 align-items-center">
            <div class="col-4 pt-4">
                <div class="card text-center">
                    <div class="container my-5" id="size"
                        style="background-color: #424242; height: 250px; width: 250px"> a
                    </div>
                    <!--<img src="/img/doun1.jpg" class="card-img-top" alt="...">-->
                    <div class="card-body py-3 px-3">
                        <h5 class="card-title" style="font-weight: bold">Custom GIF</h5>
                        <p class="card-text">Buat pinned gif yang sesuai dengan keinginan kamu disini!</p>
                        <p>3 Slot Tersedia</p>
                        <a href="/Home/order/twitter_profile_needs/custom_gif" class="btn"
                            style="background-color: #DAA520; color:#424242">ORDER HERE</a>
                    </div>
                </div>
            </div>
            <div class="col-4 pt-4">
                <div class="card text-center">
                    ...
                    <!--<img src="/img/doun2.jpg" class="card-img-top" alt="...">-->
                    <div class="card-body py-3 px-3">
                        <h5 class="card-title" style="font-weight: bold">Template GIF</h5>
                        <p class="card-text">Kamu bingung? tenang kami juga menyediakan template yang ga kalah bagusnya
                            :)</p>
                        <p>Slot Habis</p>
                        <a href="/Home/order/twitter_profile_needs/template_gif" class="btn"
                            style="background-color: #DAA520; color:#424242">ORDER HERE</a>
                        <!--<button type="button" class="btn" style="background-color: #DAA520; color:#424242" disabled>OUT
                            OF STOCK</button>-->
                    </div>
                </div>
            </div>
                ...
                <div class="col-2">
                    <div class="row">
                        <a class="btn btn-sm text-left" href="http://twitter.com/pikuupa" role="button">
                            <img src="/img/twitter-black-shape.png" class="img-fluid"
                                style="color: #ffffff; max-width:10%;" alt="testi-1">
                            @pikuupa
                        </a>
                    </div>
                    <div class="row">
                        <a class="btn btn-sm text-left" href="mailto:pikuupa@gmail.com" role="button">
                            <img src="/img/email.png" class="img-fluid" style="max-width:10%;" alt="testi-1">
                            pikuupa@gmail.com
                        </a>
                    </div>
                </div>

    ...
    <div class="container my-5 py-2 text-center">
            ...
            <nav aria-label="Size navigation">
                <ul class="pagination">
                    <li class="page-item active"><a class="page-link px-4"
                            href="/portofolios/index/twitter_profile_needs/11"
                            style="font-weight: bold; background-color: #FEB724; border: 1px solid rgba(0, 0, 0, 0.05); color:#424242">1
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 py-4">
                <img src="/porto/11/<?= $d['file']; ?>" class="card-img-top">
            </div>
            <?php endforeach; ?>
        </div>
    </div>

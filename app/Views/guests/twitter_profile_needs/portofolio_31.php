...
<head>
    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-light bg-light" style="color:#424242;">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            ...
            <a class="nav-link px-2" role="button" style="font-weight:700; text-align: center;" href="/login">LOGIN</a>
                <div class="divider" style="width:10px;
    height:auto;
    display:inline-block;"></div>
                <a class="nav-link px-2" role="button" style="background-color: #FEB724; 
                                                              border: none;
                                                              padding: 10px 24px;
                                                              text-align: center;
                                                              ...
                                                              font-size: 16px;
                                                              font-weight: 700;
                                                              display: inline-block;" href="/register">REGISTER</a>
            </div>
        </div>
    </nav>
</head>
...
<body style="background-color:#f7f7f7; font-family: Montserrat; font-style: normal; color: #424242;">
    <div class="container my-5 py-2 text-center">
        ...
        <div class="row">
            <div class="col pt-3 px-lg-5">
                <h5><small class="text-secondary"
                        style="font-weight: normal; font-size: 16px; line-height: 29px; color: #424242;">Twitter Profile
                        Needs</small>
                </h5>
            </div>
        </div>
            ...
            <nav aria-label="Size navigation">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link px-4" href="/portofolios/index/twitter_profile_needs/11"
                            ...
                            : 1</a></li>
                    <li class="page-item"><a class="page-link px-4" href="/portofolios/index/twitter_profile_needs/21"
                            style="font-weight: bold; background-color: rgba(225, 225, 225, 0.5); border: 1px solid rgba(0, 0, 0, 0.05); color:#424242">2
                            : 1</a></li>
                    <li class="page-item active"><a class="page-link px-4"
                            href="/portofolios/index/twitter_profile_needs/31"
                            style="font-weight: bold; background-color: #FEB724; border: 1px solid rgba(0, 0, 0, 0.05); color:#424242">3
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 py-4">
                <img src="/porto/31/<?= $d['file']; ?>" class="card-img-top">
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="row mt-5 pt-5 pb-2 mx-0 justify-content-center text-center"
        ...
        <div class="col align-self-center pt-5 px-5">
            <h2 style="color: #424242;">Mau punya gif kayak di atas?<br>Pesan sekarang juga!</h2>
        </div>
    </div>

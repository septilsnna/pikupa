    ...
    <div class="container my-5 py-2 text-center">
        ...
        <div class="row justify-content-center pt-3 px-lg-5">
            <nav aria-label="Size navigation">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="/Home/portfolio/twitter_profile_needs/11"
                    ...
                    <li class="page-item"><a class="page-link" href="/Home/portfolio/twitter_profile_needs/21"
                            ...
                            : 1</a></li>
                    <li class="page-item active"><a class="page-link" href="/Home/portfolio/twitter_profile_needs/31"
                            style="background-color: #FEB724; border: 1px solid rgba(0, 0, 0, 0.2); box-sizing: border-box; color:#424242">3
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 py-4">
                <img src="/31/<?= $portofolios[$i]['file']; ?>.gif" class="card-img-top">
            </div>
            <?php endfor; ?>
        </div>
    </div>

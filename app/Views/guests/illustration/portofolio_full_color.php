    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-light bg-light" style="color:#424242;">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <div class="navbar-nav">
                <a class="nav-link px-2" role="button" style="font-weight:700; text-align: center;"
                    href="/login">LOGIN</a>
    ...
    <div class="container my-5 py-2 text-center">
        ...
        <div class="row justify-content-center pt-3 px-lg-5">
            <nav aria-label="Size navigation">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link px-4" href="/portofolios/index/illustration/outline"
        ...
        <div class="pt-3" style="columns: 2; column-gap: 16px;">
            ...
            <div style="display: inline-block; position: relative; margin-bottom: 16px;">
                <img style="width: 100%; border-radius: 5px;" src="/porto/full_color/<?= $d['file'] ?>">
            </div>
            <?php endforeach; ?>
        </div>
    </div>

    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-light bg-light" style="color:#424242;">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <div class="navbar-nav">
                <a class="nav-link btn px-2" role="button" href="/profile/index">Halo, <?= $nama; ?>!</a>
    ...
    <div class="container my-5 py-2 text-center">
            ...
            <nav aria-label="Size navigation">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="/portofolios/index/twitter_profile_needs/21"
                            ...
                            : 1</a></li>
                    <li class="page-item active"><a class="page-link" href="/portofolios/index/twitter_profile_needs/31"
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 py-4">
                <img src="/31/<?= $portofolios[$i]['file']; ?>" class="card-img-top">
            </div>
            <?php endfor; ?>
        </div>
    </div>

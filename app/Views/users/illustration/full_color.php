        ...
        <div class="row my-4">
            <div class="col-md-4 pt-4">
                <div class="card shadow bg-white">
                    <img src="/catalog/head-color.jpg" class="card-img-top">
            ...
            <div class="col-md-4 pt-4">
                <div class="card shadow bg-white">
                    <img src="/catalog/half-body-color.jpg" class="card-img-top">
                    <div class="card-body text-center py-3 px-3" style="height: 200px">
                        <h5 class="card-title pt-4" style="font-size: 24px; font-weight: bold">
                            HALF BODY
                        </h5>
            ...
            <div class="col-md-4 pt-4">
                <div class="card shadow bg-white">
                    <img src="/catalog/full-body-color.jpg" class="card-img-top">
                    <div class="card-body text-center py-3 px-3" style="height: 200px">
                        <h5 class="card-title pt-4" style="font-size: 24px; font-weight: bold">
                            FULL BODY
                        </h5>
